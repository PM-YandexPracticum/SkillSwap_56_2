...
// Временная страница для ревью фильтров каталога — удалить вместе с веткой chore/filters-playground
const FiltersPlaygroundPage = lazy(() => import('@/pages/FiltersPlaygroundPage'))
  ...
  return (
    <BrowserRouter>
      <Suspense fallback={<div>Загрузка...</div>}>
        <Routes>
          <Route path="/playground/filters" element={<FiltersPlaygroundPage />} />
